...
/*
mainView.CoreWebView2.AddHostObjectToScript("binder", new Binder());

await binder.Commit(bytes);
*/
...
$(() => {
	...
	// WebView2일 경우
	if (window.chrome.webview && chrome.webview.hostObjects && chrome.webview.hostObjects.binder) {
