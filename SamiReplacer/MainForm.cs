...
namespace Jamaker
{
    public partial class MainForm : Form
    {
        ...
        public MainForm(string[] args)
        {
            ...
            try
            {   // 설정 파일 경로
                sr = new StreamReader(Path.Combine(Application.StartupPath, "setting/SamiReplacer.txt"), Encoding.UTF8);
            ...
            mainView.LoadUrl(Path.Combine(Application.StartupPath, "view/SamiReplacer.html"));
        ...
        public void ExitAfterSaveSetting(string setting)
        {
            ...
            try
            {
                ...
                sw = new StreamWriter(Path.Combine(Application.StartupPath, "setting/SamiReplacer.txt"), false, Encoding.UTF8);
